...
export class GIGeomIO {
    ...
    //     // all entities get the same time stamp
    //     const ts: number = this.modeldata.active_snapshot;
    ...
    //         this.modeldata.getObjsUpdateTs(EEntType.POINT, geom_data.points_i[i]); // time stamp
    //     }
    //     // add plines to model
    ...
    //         this.modeldata.getObjsUpdateTs(EEntType.PLINE, geom_data.plines_i[i]); // time stamp
    //     }
    //     // add pgons to model
    ...
    //         this.modeldata.getObjsUpdateTs(EEntType.PGON, geom_data.pgons_i[i]); // time stamp
    //     }
    //     // add collections to model
    //     this._geom_maps.colls = new Set();
    //     for (let i = 0; i < geom_data.colls_i.length; i++) {
    //         throw new Error('Not implemented');
    //         // this.modeldata.attribs.colls.setCollPoints(geom_data.colls_i[i], geom_data.colls_points[i]);
    //         // this.modeldata.attribs.colls.setCollPlines(geom_data.colls_i[i], geom_data.colls_plines[i]);
    //         // this.modeldata.attribs.colls.setCollPgons(geom_data.colls_i[i], geom_data.colls_pgons[i]);
    //         // this._geom_maps.up_colls_colls.set(geom_data.colls_i[i], geom_data.colls_parents[i]);
    //         this.modeldata.getObjsUpdateTs(EEntType.COLL, geom_data.colls_i[i]); // time stamp
    //     }
    //     // set selected
    //     this.modeldata.geom.selected = geom_data.selected;
    //     // ========================================================================================
    ...
    //     //         if (!this.modeldata.attribs.colls.getPointColls(point_i)) {
    ...
    //     //         if (!this.modeldata.attribs.colls.getPlineColls(pline_i)) {
    ...
    //     //         if (!this.modeldata.attribs.colls.getPgonsColls(pgon_i)) {
