...
export class GIGeomClone {
     ...
     */
    public dump(ssid: number, geom_maps: IGeomMaps): void {
        // deep copys
        ...
        this._geom_maps.colls = new Set(geom_maps.colls);
        // ======================================================================
    }
    /**
     * Adds data to this model from another model.
     ...
     * @param geom_maps The geom_arrays of the other model.
     */
    public dumpEnts(ssid: number, other_geom: GIGeom, ent_sets: IEntSets): void {
