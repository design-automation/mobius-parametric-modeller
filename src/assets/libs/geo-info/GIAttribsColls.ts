...
export class GIAttribsColls {
   ...
   /**
    ...
    public getPointColls(point_i: number): number[] {
        ...
        return this.modeldata.geom.snapshot.getEntsActive(EEntType.COLL).filter( coll_i => {
    ...
    public getCollPoints(coll_i: number): number[] {
        const ents_i: number[] = this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_POINTS, ) as number[];
    ...
    public getCollPlines(coll_i: number): number[] {
        const ents_i: number[] =  this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_PLINES) as number[];
        if ( ents_i === undefined) { return []; }
        return Array.from(ents_i);
    }
    /**
    ...
    public getCollPgons(coll_i: number): number[] {
        const ents_i: number[] =  this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_PGONS) as number[];
        if ( ents_i === undefined) { return []; }
        return Array.from(ents_i);
    }
    /**
    ...
    public getCollChildren(coll_i: number): number[] {
        const ents_i: number[] =  this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_CHILDS) as number[];
        if ( ents_i === undefined) { return []; }
        return Array.from(ents_i);
    }
    /**
    ...
    public getCollParent(coll_i: number): number {
        return this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_PARENT) as number;
    }
    // ============================================================================================
    ...
    public addCollPoints(coll_i: number, points_i: number|number[]): void {
        ...
        const exist_points_i: number[] = this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_POINTS) as number[];
    ...
    public addCollPlines(coll_i: number, plines_i: number|number[]): void {
        ...
        const exist_plines_i: number[] = this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_PLINES) as number[];
    ...
    public addCollPgons(coll_i: number, pgons_i: number|number[]): void {
        ...
        const exist_pgons_i: number[] = this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_PGONS) as number[];
    ...
    public addCollChildren(coll_i: number, child_colls_i: number[]): void {
        ...
        const exist_child_colls_i: number[] = this.modeldata.attribs.query.getEntAttribVal(EEntType.COLL, coll_i, EAttribNames.COLL_CHILDS) as number[];
