...
export class GIGeomNav {
    ...
    public navCollToPoint(coll_i: number): number[] {
        ...
        const coll_and_desc_i: number[] = this._geom.modeldata.attribs.colls.getCollDescendents(coll_i);
        // if no descendants, just return the the ents in this coll
        if (coll_and_desc_i.length === 0) {
            return this._geom.modeldata.attribs.colls.getCollPoints(coll_i); // coll points
        }
    ...
    public navCollToPline(coll_i: number): number[] {
        ...
        // if no descendants, just return the the ents in this coll
        if (coll_and_desc_i.length === 0) {
            return this._geom.modeldata.attribs.colls.getCollPlines(coll_i); // coll lines
        }
    ...
    public navCollToPgon(coll_i: number): number[] {
        ...
        // if no descendants, just return the the ents in this coll
        if (coll_and_desc_i.length === 0) {
            return this._geom.modeldata.attribs.colls.getCollPgons(coll_i); // coll pgons
        }
    ...
    public navCollToCollChildren(coll_i: number): number[] {
        return this._geom.modeldata.attribs.colls.getCollChildren(coll_i); // coll children
    }
    // ============================================================================
    ...
    public navPointToColl(point_i: number): number[] {
        return this._geom.modeldata.attribs.colls.getPointColls(point_i);
    }
    public navPlineToColl(pline_i: number): number[] {
        return this._geom.modeldata.attribs.colls.getPlineColls(pline_i);
    }
