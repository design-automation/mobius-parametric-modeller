...
isNum = __modules__._types2.isNum;
isInt = __modules__._types2.isInt;
isFlt = __modules__._types2.isFlt;
isBool = __modules__._types2.isBool;
isStr = __modules__._types2.isStr;
isList = __modules__._types2.isList;
isDict = __modules__._types2.isDict;
isVec2 = __modules__._types2.isVec2;
isVec3 = __modules__._types2.isVec3;
isCol = __modules__._types2.isCol;
isRay = __modules__._types2.isRay;
isPln = __modules__._types2.isPln;
isNaN = __modules__._types2.isNaN;
isNull = __modules__._types2.isNull;
isUndef = __modules__._types2.isUndef;
