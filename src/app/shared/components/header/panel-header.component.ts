...
export class PanelHeaderComponent implements OnDestroy {
    ...
    onWindowMessage(event: MessageEvent) {
        ...
        //     return;
        // }
        console.log('_________________', event)
    ...
    //     console.log('............');
    //     window.postMessage({
    //         messageType: 'load_url',
    //         url: 'https://raw.githubusercontent.com/design-automation/mobius-parametric-modeller-dev/' +
    //              'master/src/assets/gallery/flow_examples/podium_with_towers.mob'
    //     }, '*');
    //     window.postMessage({
