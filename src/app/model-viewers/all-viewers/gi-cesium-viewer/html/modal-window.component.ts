...
@Component({
    selector: 'cesium-modal-window',
    styleUrls: ['./modal-window.component.scss'],
    templateUrl: './modal-window.component.html'
})

export class CesiumModalWindowComponent implements OnInit, OnDestroy {
    @Input() id: string;
    ...
    // open modal
    open(): void {
        let modalWindow = document.getElementById('cesium-modal-window');
